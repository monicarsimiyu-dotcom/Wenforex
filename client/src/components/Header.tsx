    ...
    <header className="h-14 border-b border-border bg-card/60 backdrop-blur-md px-3 lg:px-5 flex items-center justify-between z-50 shrink-0">
      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2" data-testid="brand-logo">
          ...
          <span className={`${user ? "text-sm" : "text-lg"} font-extrabold tracking-tight text-white`} data-testid="text-brand-name">
        ...
        {!user && (
          <div className="flex items-center gap-2">
            <Button
              ...
              variant="outline"
              className="h-7 w-[84px] px-0 border-white/20 bg-transparent hover:bg-white/5 text-white font-bold text-xs"
            ...
            <Button
              ...
              className="h-7 w-[84px] px-0 bg-primary hover:bg-primary/90 text-primary-foreground font-bold text-xs"
