    ...
    <header className="h-14 border-b border-border bg-card/60 backdrop-blur-md px-3 lg:px-5 flex items-center justify-between z-50 shrink-0">
      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2" data-testid="brand-logo">
          ...
          <span className="text-lg font-extrabold tracking-tight text-white hidden sm:block" data-testid="text-brand-name">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        {user && (
          <>
            ...
            {/* Balance */}
            <div
              className="flex items-center bg-background/60 border border-white/10 rounded-lg pl-3 pr-1 py-1 gap-2"
            ...
            >
              <div className="flex flex-col items-end leading-tight">
                ...
                <span className={`font-mono font-bold text-sm ${isLive ? "text-green-400" : "text-primary"}`}>
